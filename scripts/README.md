...
- [`idempotent/configure-docker-insecure-registries.sh`](idempotent/configure-docker-insecure-registries.sh) ajoute ou retire de façon idempotente des exceptions TLS Docker sur Debian 12, avec sauvegarde et validation de `daemon.json`.
