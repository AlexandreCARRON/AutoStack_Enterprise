...
Le générateur `scripts/generate-apisix-demo-config.py` lit ce classeur sans le modifier et produit les objets JSON dans le répertoire d'exécution ignoré par Git de la variante de démonstration.
