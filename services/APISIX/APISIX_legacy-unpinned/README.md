...
sensitivity: public
sources: ["services/APISIX/APISIX_legacy-unpinned/docker-compose.yml", "services/APISIX/APISIX_legacy-unpinned/script.sh"]
---
...
- [`script.sh`](script.sh) contient l'ancien installateur POC ;
