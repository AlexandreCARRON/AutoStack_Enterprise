...
read -r -p "=> REBOOT - Etes-vous ok pour redémarrer le serveur maintenant de manière à ce que le nouveau PATH soit pris en compte ? (Y/n) /n Il vous suffira de relancer le script pour continuer l'installation !" response
